...
@NgModule(
  ...
  ,exports = @@[RemarkComponent, TabComponent, TabsComponent, CollapsedWellComponent, DottedStringPairComponent, DotComponent, StringMapComponent, StringListComponent, ControlComponent]
)
